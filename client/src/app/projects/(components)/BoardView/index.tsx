              ...
              <>
                {task.assignee.profilePictureUrl ? (
                  <Image
                    ...
                    src={`https://pm-s3-images-bucket.s3.amazonaws.com/${task.assignee.profilePictureUrl}`}
              ...
              <>
                {task.author.profilePictureUrl ? (
                  <Image
                    ...
                    src={`https://pm-s3-images-bucket.s3.amazonaws.com/${task.author.profilePictureUrl}`}
