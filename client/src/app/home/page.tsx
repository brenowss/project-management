...
const HomePage = () => {
  ...
  return (
    <div className="container h-full w-full bg-gray-100 bg-transparent p-8">
      <Header name="Project Management" />
        ...
        <div className="rounded-lg bg-white p-4 shadow dark:bg-dark-secondary">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={taskDistribution}>
              <CartesianGrid
                strokeDasharray="3 3"
                stroke={chatColors.barGrid}
              />
              <XAxis dataKey="name" stroke={chatColors.text} />
              <YAxis stroke={chatColors.text} />
              <Tooltip
                contentStyle={{
                  width: "min-content",
                  height: "min-content",
              ...
              />
              <Legend />
              <Bar dataKey="count" fill={chatColors.bar} />
            </BarChart>
          </ResponsiveContainer>
        </div>
